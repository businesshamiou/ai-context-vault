...
| 8 | Jonctions des skills du Vault | pour chaque `vault/skills/<nom>/SKILL.md` (hors `external/`) : jonction du même nom, `test -ef` IDENTIQUE | `mklink /J` (ou `ln -s`) vers `vault/skills/<nom>`, jamais sur une jonction existante | machine |
